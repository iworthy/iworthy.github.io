...
author:
  name: worthy
createTime: 2017/08/14 20:34:00
---


教程:如何使用hexo+github搭建免费个人博客<!--more-->
> 本文基本内容取自源柳夏南的博客，亲身安装后进行了相关更改，如有需求请点击[原文连接](http://blog.liuxianan.com/build-blog-website-by-hexo-github.html)，吃水不忘挖井人在这里感谢原作者。
...
- Windows10专业版
- [node.js@6.11.2 LTS](https://nodejs.org/zh-cn/)
- [git@2.14.1](https://git-scm.com/downloads)
- [hexo@3.3.8](https://hexo.io/zh-cn/index.html)

## 搭建github博客

### 一、创建仓库

新建一个名为你的**用户名.github.io**的仓库，比如说，如果你的github用户名是test，那么你就新建**test.github.io**的仓库（必须是你的用户名，其它名称无效），将来你的网站访问地址就是 http://test.github.io 了，是不是很方便？
...
<!-- 原图片：https://yun.worthy.cc/worthy/2017081401.png -->
> 历史图片暂不可用（原图托管服务已下线）。
...
<!-- 原图片：https://yun.worthy.cc/worthy/2017081402.png -->
> 历史图片暂不可用（原图托管服务已下线）。
...
<!-- 原图片：https://yun.worthy.cc/worthy/2017081403.png -->
> 历史图片暂不可用（原图托管服务已下线）。
...
<!-- 原图片：https://yun.worthy.cc/worthy/2017081404.png -->
> 历史图片暂不可用（原图托管服务已下线）。
...
<!-- 原图片：https://yun.worthy.cc/worthy/2017081405.png -->
> 历史图片暂不可用（原图托管服务已下线）。
...
<!-- 原图片：https://yun.worthy.cc/worthy/2017081406.png -->
> 历史图片暂不可用（原图托管服务已下线）。
...
<!-- 原图片：https://yun.worthy.cc/worthy/2017081407.png -->
> 历史图片暂不可用（原图托管服务已下线）。
...
<!-- 原图片：https://yun.worthy.cc/worthy/2017081408.png -->
> 历史图片暂不可用（原图托管服务已下线）。
...
<!-- 原图片：https://yun.worthy.cc/worthy/2017081409.png -->
> 历史图片暂不可用（原图托管服务已下线）。

我们只需要打开这个文件就可以开始写博客了，默认生成如下内容：

<!-- 原图片：https://yun.worthy.cc/worthy/2017081410.png -->
> 历史图片暂不可用（原图托管服务已下线）。
...
<!-- 原图片：https://yun.worthy.cc/worthy/2017081411.png -->
> 历史图片暂不可用（原图托管服务已下线）。
...
<!-- 原图片：https://yun.worthy.cc/worthy/2017081412.png -->
> 历史图片暂不可用（原图托管服务已下线）。

## 后记 ##

1. 本文所有命令都是在git bash终端里进行。
2. 总所周知的原因，npm下载过慢，这里推荐使用[淘宝 NPM 镜像](https://npm.taobao.org/)
3. 搭建node.js时可能遇到问题，建议浏览[如何在 Windows 10 中搭建 Node.js 环境？](http://blog.oneapm.com/apm-tech/744.html)
4. 相关参考：[小白独立搭建博客--Github Pages和Hexo简明教程](https://my.oschina.net/ryaneLee/blog/638440)
5. 知乎相关问题：[如何在 GitHub 上写博客？](https://www.zhihu.com/question/20962496)
