---
title: 微软 PowerToys 使用说明
date: 2020/06/27 20:20:00
tags: null
permalink: /pages/0d4ed0/
sidebar: true
comment: false
editLink: false
article: true
author:
  name: worthy
createTime: 2020/06/27 20:20:00
---


Power Toys 是微软为 Windows 系统推出的一系列免费实用小工具合集。极大方便了Windows的使用，但软件没有汉化，奈何还是一个英语渣渣，只能记录一下使用方法，方便使用。
...
## PowerToys Run 应用启动器
按下 Alt + 空格 即可随时呼出输入框。搜索到的结果之后，可以回车打开，也可以按下 Ctrl + C 复制文件或文件夹所在的路径，也能按下 Ctrl + Shift + E 打开文件所在的目录 。
...
### Windows Key Shortcut Guide「Windows 快捷键指南」
可以让用户在长按 Windows 键超过 1 秒时，显示出当前桌面状态下可用的快捷键列表。 (Win热键快捷键指南)


项目地址：https://github.com/microsoft/PowerToys
内容来自：https://www.iplaysoft.com/powertoys.html


  [1]: /images/2020/06/27/1593261264.png
